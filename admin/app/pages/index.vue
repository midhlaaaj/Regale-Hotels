...
import type { AdminBooking, DashboardData, Property } from "~/types/api";
  ...
  <div>
    ...
    <div class="border border-outline/20 bg-white">
      <div class="border-b border-outline/20 px-5 py-4 flex justify-between items-center">
        ...
        <NuxtLink to="/bookings" class="font-label-ledger text-xs uppercase text-primary">View all</NuxtLink>
      </div>
