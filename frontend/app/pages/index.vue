    ...
    <section class="max-w-container-max mx-auto md:px-margin-desktop py-24 overflow-hidden">
      ...
      >
        <template v-if="testimonialsPending">
          <div v-for="i in 3" :key="i" class="bg-surface-container-lowest p-8 rounded-lg border border-outline/20 shadow-[4px_4px_0px_rgba(27,48,34,0.1)] w-full md:w-auto flex-shrink-0 snap-center">
        ...
        <TestimonialCard
          ...
          class="w-full md:w-auto flex-shrink-0 snap-center"
        />
      </div>
    </section>
  </div>
