...
The original UI reference lives in [`design-reference/Regale Site.dc.html`](./design-reference/Regale%20Site.dc.html) (customer site) and [`design-reference/Regale Admin.dc.html`](./design-reference/Regale%20Admin.dc.html) (admin panel) — both were used as the source of truth for structure, copy, and the Heritage Ledger design system while building the two Nuxt apps.
